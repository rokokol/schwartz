function [u_new, max_diff] = schwartz_add_step_cont(u_old, A_cells, f_int, starts, ends_arr, glob_lower, glob_upper, bpoints)
    ...
    for i = 1:bpoints
        idx_int = starts(i) : ends_arr(i); 
        u_new_sum(idx_int + 1) = u_new_sum(idx_int + 1) + u_locals{i};
