% TODO: Нужно исправить ошибку, при которой при intersect_points=2 метод не работает

function [u_approx, E] = schwartz_2d(n, a, b, intersect_points, f, u_0, u_n, accuracy, trace)
if trace
  hold on; grid on;
end
