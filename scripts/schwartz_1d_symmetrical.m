...
function [U, e] = schwartz_1d_symmetrical(x, bpoints, intersect_points_radius, f, u_0, u_n, accuracy, is_mult, trace, target_ax)
...
% intersect_points_radius >= 2
  ...
  if is_mult
      method = @schwartz_mult_step;
  else
      method = @schwartz_add_step;
  end
  ...
  while flag
      ...
      [u_next, max_diff] = method(u_curr, A, f_int, starts, ends_arr, glob_lower, glob_upper, bpoints);
